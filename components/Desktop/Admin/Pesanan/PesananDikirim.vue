                        ...
                        <div
                            ...
                            <div class="text-center">
                                ...
                                <h3 class="mb-4 text-lg font-semibold text-gray-800">
                                    Konfirmasi Selesai Pesanan "{{ pemesanan.kode_pemesanan }}"
                                </h3>
                                <p class="mb-6 text-gray-500">Apakah kamu yakin ingin menyelesaikan proses pesanan ini?</p>
...
const fetchPemesanans = async () => {
    try {
        ...
        const { data } = await useFetch(
            `http://be-zakkiPedia.test/api/v1/getPemesananAdmin?&q=${formData.value.s}&status=Dikirim&page=${page.value}`,
...
const submitData = async (id) => {
    try {
        ...
        toast.add({ title: 'Success Selesai 1 Data Pesanan' });
