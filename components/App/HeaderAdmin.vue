    ...
    <div class="relative overflow-hidden bg-sky-700 pb-32">
        <nav class="bg-transparent relative z-10 border-b border-white border-opacity-25 lg:border-none lg:bg-transparent"
            ...
            <div class="mx-auto max-w-7xl px-2 sm:px-4 lg:px-8">
                <div class="relative flex h-16 items-center justify-between lg:border-b lg:border-white">
                    ...
                    <div class="flex flex-1 justify-end px-2 lg:ml-6 lg:justify-end">
                        <div class="flex-none h-full text-center flex items-center justify-end">
                            <div
                                class="flex space-x-2 lg:space-x-3 items-center px-2 lg:px-3 rounded-xl bg-[#c8a876] py-1 lg:py-1.5 hover:text-black hover:bg-[#b49463] hover:-translate-y-1 transition-all duration-500">
        ...
        <header class="relative py-6">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-white">Homepage Admin</h1>
            </div>
        </header>
    </div>
</template>